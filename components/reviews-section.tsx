          ...
          <Card className="bg-accent/5 border-accent/20 max-w-2xl mx-auto">
            <CardContent className="pt-8 pb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="#projects"
                  className="inline-flex items-center justify-center rounded-md text-sm font-medium disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:text-white hover:bg-[#272727] h-10 px-4 py-2"
                >
                  View Portfolio
                </a>
              </div>
